...
// spedometer inharites from Qt paint-item
...
public:
    ...
    // virtual paint method (needs to be impelment, otherwise there will be a compile error - is used to draw the )
...
private:
    // see construtor in cpp for more details
